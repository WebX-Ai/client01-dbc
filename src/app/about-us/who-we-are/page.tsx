...
const page = () => {
  ...
  return (
    <div className="space-y-10 sm:space-y-24 p-5 container m-auto">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl">THE SERVICES & SOLUTIONS WE PROVIDE</h1>
        <div className="space-y-4">
          <div className="">
            ...
            <p className="text-gray-500">
              ...
              performance, and cost-effectiveness. Your business solutions will
              integrate the best in advanced hardware components, supporting
              software and consumable supplies. In addition, our service options
              will carry you far beyond standard product warranties.
            </p>
          </div>
          <div className="">
            <span className="font-semibold text-lg text-gray-800">
            ...
            <p className="text-gray-500">
              ...
              experts in the industries they serve. They are trained by factory
              experts in proper application and support of technology. Regular
              factory training is mandatory for all Reps, to assure their
              clients of the right product to fit the client’s application.
              Whether your requirement is for a solution to a time and
              attendance problem, or if you need to integrate a barcode scanner
              with a scale for shipping; whether you need to track goods in
              process for manufacturing or add barcode tracking for order
              picking in a warehouse, our Technical Consultants have the
              experience to provide a trusted solution.
            </p>
          </div>
          <div className="">
            <span className="font-semibold text-lg text-gray-800">
            ...
            <p className="text-gray-500">
              ...
              questions, use our email address, or reach us via an online chat.
              Utilizing our modern service facility, factory-certified
          ...
          <div className="">
            ...
            <br />{" "}
            <p className="text-gray-500">
              Dream Big Corporation offers confidence in the long-term value of
              your data collection system. As a business partner, we are
              dedicated to providing the highest level of customer satisfaction
              in sales and customer support. Let our experience and commitment
              to excellence put barcode technology to work for you today. If you
