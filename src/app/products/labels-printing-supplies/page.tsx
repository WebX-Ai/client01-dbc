    ...
    <div className="p-6 container m-auto space-y-6">
      ...
      <div className="space-y-6">
        <h1 className="text-4xl font-bold">
          CUSTOM LABELS AND PRINTING SOLUTIONS TO FIT ANY APPLICATION YOU COULD
          IMAGINE.
        </h1>
        <p className="text-lg font-light">
          ...
          high tech environment. We offer blank, pre-printed, and custom labels
          along with additional media supplies and accessories. With labeling
          solutions to fit any requirement large or small, our in-house team of
          label specialists can assist you in selecting the materials,
          adhesives, and barcode/rfid technology you&apos;re looking for.
          Additionally, we can even provide assessments, setup, installation,
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-5 w-full flex-wrap">
            {industries.map(({ id, name, icon }) => (
              ...
              >
                <FontAwesomeIcon icon={icon} size="3x" />
                <h2 className="font-bold text-2xl group-hover:text-white">{name}</h2>
              </div>
            ))}
          </div>
        </div>
