      ...
      <div className="space-y-14">
        <div className="space-y-2">
          ...
          <p className="text-lg font-light">
            ...
            using devices from corded to wireless, fixed mounted to mobile, and
            rugged for extreme environments. Dream Big Corporation offers free assessments to
            take a look at your entire business workflow to uncover your
            specific needs. Our products and services include everything from
            assessments and recommendations to development, configuration,
            installation, implementation, monitoring, management, and technical
            training, repair, and support. From picking/staging, put-away, to
            cross docking and returns our inventory management solutions can
            address any process challenge your business may be facing. We have
            the hardware, software, and supplies available as your go-to
            integrator and solution provider for all of your inventory
            management needs.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-medium border-primary">PRODUCTS</h1>
          <div className="flex gap-10 w-full flex-wrap">
