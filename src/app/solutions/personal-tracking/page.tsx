        ...
        <div className="space-y-14">
          <div className="space-y-2">
            ...
            <p className="sm:text-lg font-light">
              ...
              procedures in the event of an incident. Additionally, our tracking
              solutions help event planners and sports venues with RFID
              personnel tracking to create a unique experience for attendees.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="sm:text-lg font-light">
              ...
              RFID is only effective when tags are in range of RFID readers.
              This means that personnel, employees or event attendees will not
              be tracked with this technology once they leave the RFID-enabled
              area.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="sm:text-lg font-light">
              ...
              the safety and security of your employees is your top priority.
              RFID mustering can be a life-saving technology, allowing you to
              locate personnel during an emergency. In a typical scenario,
              employees exit your facility and meet at a mustering location. A
              fixed RFID reader is installed at the location, confirming who has
              safely left the building. Emergency personnel can use this system
              in real-time to determine which employees have exited, and which
              ones may still be in the building.
            </p>
          </div>
          <div className="space-y-2">
            <h1 className="sm:text-3xl font-normal">
            ...
            <p className="sm:text-lg font-light">
              ...
              These enable the ability to track attendees throughout an event to
              identify high traffic areas, popular breakout sessions etc. For
              the attendees, they serve the standard identification purpose, but
              also become a keepsake post-event.
            </p>
          </div>
          <div className="space-y-2">
