      ...
      <div className="space-y-6">
        ...
        <div className="">
          <p className="text-lg font-light">
            ...
            placement while eliminating, errors, costs, and downtime. Print and
            apply solutions can ensure consistency with the positioning of all
            labels. Regulatory and customer requirements are maintained with a
            high-level of certainty to reduce chargebacks and overall costs.
          </p>
        </div>
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            ...
            <ul className="list-disc ml-5">
              <li>Compliance and Regulatory Standards met with consistency</li>
