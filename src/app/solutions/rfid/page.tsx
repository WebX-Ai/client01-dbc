      ...
      <div className="space-y-14">
        <div className="space-y-2">
          ...
          <p className="text-lg font-light">
            Dream Big Corporation works with large corporations and mid-size businesses that
            need systems in place to track and manage critical assets from the
            office, in the field, warehouse or distribution center, and
            throughout the entire supply chain process. Our RFID asset tracking
            systems and solutions include varying levels of technology and
            automation from a standalone system to fully interfaced/integrated
            system based on the complexities of your business.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-medium border-primary">RFID SERVICES</h1>
          <div className="flex gap-10 w-full flex-wrap">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-medium border-primary">RFID PRODUCTS</h1>
          <p>
            Our solutions require many pieces working together and Dream Big Corporation has the
            knowledgeable professionals with the experience your business is
            looking for. We have the Tags, Printers, Encoders, Readers, and
            accessories to go with your current or future system.
          </p>
          <div className="flex gap-10 w-full flex-wrap">
