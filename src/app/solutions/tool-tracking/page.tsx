    ...
    <div className="p-6 container m-auto space-y-6">
      ...
      <div className="space-y-14">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold">IT’S WORKING TIME</h1>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-lg font-light">
            ...
            <br />
            Dream Big Corporation  provides barcode and RFID tracking solutions and software that
            can address your company’s needs and save you precious resources.
            We’re all about making you better, so you can keep doing what you do
            best!
          </p>
        </div>
        <div className="space-y-5">
          ...
          <div className="flex gap-20">
            <div className="space-y-2">
              <h1 className="text-2xl font-normal border-primary ">
                RFID TOOL TRACKING
              </h1>
              <ul className="list-disc ml-5">
                <li>
                  RFID Tags: Place these tags on tools you would like to track.
                </li>
                <li>
                  RFID Readers: Mount these readers at designated site areas to
                  read the RFID tags.
                </li>
                <li>
                ...
                <li>
                  RFID Cables: Use these cables to enable communication between
                  the readers and antennas.
                </li>
              </ul>
            </div>
            <div className="space-y-2">
              ...
              <ul className="list-disc ml-5">
                ...
                <li>
                  Barcode Printers: Choose from top-of-the-line barcode printers
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-normal">TOOL TRACKING SOFTWARE</h1>
          <p className="text-lg font-light">
        ...
        <div className="space-y-2">
          ...
          <div className="">
            ...
            <div className="">
              <h2 className="text-xl font-black text-primary">Take Control</h2>
              <p>
